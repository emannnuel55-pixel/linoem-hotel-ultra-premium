...
chcp 65001 >nul
title HTJ Centro de Trabajo V10 - GitHub y Railway
...
echo ================================================================
echo   ACTUALIZADOR CENTRO DE TRABAJO HTJ V10 ^| GITHUB + RAILWAY
echo ================================================================
echo.
...
echo [2/6] Copiando Centro de Trabajo, tickets y documentos HTJ...
...
git commit -m "HTJ V10: centro de trabajo, tickets y buzon seguro"
if errorlevel 1 (
  popd
  goto :git_error
)
