...
chcp 65001 >nul
title HTJ Hotel Premium V6 - GitHub y Railway
...
echo ================================================================
echo   ACTUALIZADOR HTJ PREMIUM V6 ^| GITHUB + RAILWAY
echo ================================================================
echo.
...
git commit -m "HTJ V4: login premium, contraste y flujos operativos"
if errorlevel 1 (
  popd
  goto :git_error
)
