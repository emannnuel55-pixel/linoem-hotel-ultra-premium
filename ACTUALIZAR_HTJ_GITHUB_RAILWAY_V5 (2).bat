...
chcp 65001 >nul
title HTJ Hotel Premium V5 - GitHub y Railway
...
echo ================================================================
echo   ACTUALIZADOR HTJ PREMIUM V5 ^| GITHUB + RAILWAY
echo ================================================================
echo.
...
git commit -m "HTJ V3: logo oficial, portal premium y sincronizacion"
if errorlevel 1 (
  popd
  goto :git_error
)
