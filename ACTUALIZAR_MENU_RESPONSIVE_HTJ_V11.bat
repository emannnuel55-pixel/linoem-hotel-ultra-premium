...
chcp 65001 >nul
title HTJ Menu Responsive V11 - GitHub y Railway
...
echo ================================================================
echo   ACTUALIZADOR MENU RESPONSIVE HTJ V11 ^| GITHUB + RAILWAY
echo ================================================================
echo.
...
echo [2/6] Copiando correccion responsive del menu HTJ...
...
git commit -m "HTJ V10.1: menu lateral responsive y desplazable"
if errorlevel 1 (
  popd
  goto :git_error
)
