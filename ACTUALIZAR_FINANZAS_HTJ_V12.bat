...
chcp 65001 >nul
title HTJ Finanzas Funcional V12 - GitHub y Railway
...
echo ================================================================
echo   ACTUALIZADOR FINANZAS FUNCIONAL HTJ V12 ^| GITHUB + RAILWAY
echo ================================================================
echo.
...
echo [2/6] Copiando correccion del registro financiero HTJ...
...
git commit -m "HTJ V10.2: formulario de gastos funcional y trazable"
if errorlevel 1 (
  popd
  goto :git_error
)
