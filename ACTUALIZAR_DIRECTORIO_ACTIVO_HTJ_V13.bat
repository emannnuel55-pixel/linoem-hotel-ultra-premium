...
chcp 65001 >nul
title HTJ Directorio Activo V13 - GitHub y Railway
...
echo ================================================================
echo   ACTUALIZADOR DIRECTORIO ACTIVO HTJ V13 ^| GITHUB + RAILWAY
echo ================================================================
echo.
...
echo [2/6] Copiando Directorio Activo y recuperacion segura HTJ...
...
git commit -m "HTJ V10.3: directorio activo y recuperacion segura"
if errorlevel 1 (
  popd
  goto :git_error
)
