...
chcp 65001 >nul
title HTJ Hotel Propietario V7 - GitHub y Railway
...
echo ================================================================
echo   ACTUALIZADOR HTJ PROPIETARIO V7 ^| GITHUB + RAILWAY
echo ================================================================
echo.
...
git commit -m "HTJ V5: propietario maestro automatico y permisos completos"
if errorlevel 1 (
  popd
  goto :git_error
)
