...
chcp 65001 >nul
title HTJ Dashboard Real V9 - GitHub y Railway
...
echo ================================================================
echo   ACTUALIZADOR DASHBOARD REAL HTJ V9 ^| GITHUB + RAILWAY
echo ================================================================
echo.
...
echo [2/6] Copiando el dashboard HTJ con datos reales...
...
git commit -m "HTJ V7: dashboard ejecutivo con metricas reales"
if errorlevel 1 (
  popd
  goto :git_error
)
